...
function Navbar() {
  ...
  return (
    <aside className="sticky top-0 flex min-h-screen w-64 flex-col border-r border-white/10 bg-slate-950/70 px-4 py-6 backdrop-blur-xl shadow-2xl max-md:min-h-auto max-md:w-full max-md:border-r-0 max-md:border-b">
      <div className="mb-8 flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
        <div className="grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-400 text-white shadow-[0_0_30px_rgba(109,124,255,0.35)]">
          <BookOpen size={18} />
        </div>

        <div>
          <h2 className="text-lg font-bold text-slate-50">CoolOJ</h2>
